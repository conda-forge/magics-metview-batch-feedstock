...
validate_recipe_outputs "magics-metview-batch-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="magics-metview-batch-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi